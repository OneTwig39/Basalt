A simple pure python library with hash functions Md5, Sha1 and Sha2 (may be vulnerable to certain edge cases, not recommended for production use)
...
Licenced under the MIT licence, see LICENCE.txt for more info